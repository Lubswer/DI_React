    ...
    <div className="min-h-screen font-['Outfit'] text-white bg-[#050505] bg-[radial-gradient(circle_at_top_center,_#1a1a1a,_#050505)] bg-fixed">
      ...
      <header className="pt-10 pb-6 px-[5%] flex flex-col items-center border-b border-white/10 bg-white/5 backdrop-blur-sm">
        ...
        <div className="text-center mt-5">
          ...
          <p className="mt-3 italic text-gray-300 max-w-lg mx-auto">
            "Sin Descripción"
          </p>
        </div>
      ...
      <main className="max-w-7xl mx-auto px-[5%] py-10 grid grid-cols-1 lg:grid-cols-3 gap-10">
        ...
        <div className="space-y-8">
          ...
          <div className="flex flex-col gap-3 pt-4">
            <button className="w-full py-4 rounded-2xl bg-white text-black font-extrabold hover:bg-gray-200 transition-all uppercase tracking-widest shadow-lg">
              Editar Perfil
            </button>
